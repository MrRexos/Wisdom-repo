  ...
  return (
    <View className="flex-1">
      ...
      <KeyboardAvoidingView
        ...
        <View
          className=" flex-row items-end px-3 py-2 bg-[#f4f4f4] dark:bg-[#272626] space-x-2">
          
          <Pressable
            hitSlop={8}
            className="h-11 w-11 rounded-full items-center justify-center bg-[#e5e5e5] dark:bg-[#3d3d3d]">
