...
export default function WalletScreen() {
  ...
  return (
    <SafeAreaView style={{ flex: 1, paddingTop: Platform.OS === 'android' ? StatusBar.currentHeight ?? initialWindowMetrics?.insets?.top ?? 0 ?? initialWindowMetrics?.insets?.top ?? 0 : 0}} className='flex-1 bg-[#f2f2f2] dark:bg-[#272626]'>
