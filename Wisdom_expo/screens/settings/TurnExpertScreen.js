      ...
      <View className="flex-1 justify-start items-center">
        ...
        <View className="flex-1 w-full justify-center items-start">
          ...
          <View className="mx-8 flex-row justify-center">
            <Text className="font-inter-semibold text-[17px] text-[#444343] dark:text-[#f2f2f2]">What's included </Text>
          ...
          <View className="mt-8 mx-10 flex-row justify-start items-center">
            ...
            <Text className="ml-3 font-inter-medium text-[14px] text-[#444343] dark:text-[#f2f2f2]">-5% when booking a service</Text>
          </View>
          ...
          <View className="mt-5 mx-10 flex-row justify-start items-center">
            ...
            <Text className="ml-3 font-inter-medium text-[14px] text-[#444343] dark:text-[#f2f2f2]">Being able to offer unlimited services</Text>
          </View>
          ...
          <View className="mt-5 mx-10 flex-row justify-start items-center">
            ...
            <Text className="ml-3 font-inter-medium text-[14px] text-[#444343] dark:text-[#f2f2f2]">Increased visibility of your services</Text>
          </View>
          ...
          <View className="mt-5 mx-10 flex-row justify-start items-center">
            ...
            <Text className="ml-3 font-inter-medium text-[14px] text-[#444343] dark:text-[#f2f2f2]">Rank with quality seal</Text>
          </View>
          ...
          <View className="mt-5 mx-10 flex-row justify-start items-center">
            ...
            <Text className="ml-3 font-inter-medium text-[14px] text-[#444343] dark:text-[#f2f2f2]">+5% for each transaction of your service </Text>
          </View>
