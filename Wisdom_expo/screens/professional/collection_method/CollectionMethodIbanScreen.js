...
export default function CollectionMethodIbanScreen() {
  ...
  const { fullName, dni, dateOfBirth, phone, frontImage, backImage } = route.params;
...
onPress={() => navigation.navigate('CollectionMethodDirection', { fullName, dni, dateOfBirth, phone, frontImage, backImage, iban })}
