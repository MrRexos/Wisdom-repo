          ...
          <View className="px-5 py-3  w-full">
            ...
            <View className="justify-center items-center px-5">
              <Text className="font-inter-medium text-[13px] text-center pt-3 text-[#B6B5B5] dark:text-[#706F6E]">
                Enter your email or username and we'll send you a link where you can reset your password.
              </Text>
            </View>
          ...
          <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
              <View className="justify-center items-center pb-6">
                  ...
                  className="bg-[#323131] dark:bg-[#fcfcfc] w-[320] h-[55] rounded-full items-center justify-center" >
                      <Text className="font-inter-semibold text-[15px] text-[#fcfcfc] dark:text-[#323131] ">Send Link</Text>
                  </TouchableOpacity>
              </View>
