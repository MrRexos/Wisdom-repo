...
export default function BookingScreen() {
  ...
  const getFormattedPrice = () => {
    ...
    if (serviceData.price_type === 'hour') {
      return (
        <>
          <Text className="font-inter-bold text-[12px] text-[#444343] dark:text-[#f2f2f2]">{formatCurrency(formattedPrice, serviceData.currency)}</Text>
      ...
      return <Text className="font-inter-semibold text-[12px] text-[#706F6E] dark:text-[#B6B5B5]">{t('price_on_budget')}</Text>;
    }
  };
  ...
  const calculateEndDateTime = () => {
    ...
    startDateTime.setMinutes(startDateTime.getMinutes() + (Number(duration) || 0));
          ...
          <View className="flex-row">
            ...
            <View className="flex-1">
              ...
              <View className="justify-center items-center flex-1">
                <View className="ml-4 flex-row items-center self-start">
                  <Text className="mr-4">
                    {getFormattedPrice()}
                  </Text>
                  ...
                  {timeUndefined ? (
                    <>
                      ...
                      <View className="mt-4 flex-row">
                        ...
                        <Text className="font-inter-bold text-[13px] text-[#444343] dark:text-[#f2f2f2]">? € + {formatCurrency(1, serviceData.currency)}</Text>
                      </View>
                    ...
                    <>
                      <View className="flex-row">
                        ...
                        <Text className="font-inter-semibold text-[13px] text-[#979797] dark:text-[#979797]">
                          {formatCurrency(pricing.base, serviceData.currency)}
                        </Text>
                      </View>
                      ...
                      <View className="mt-4 flex-row">
                        ...
                        <Text className="font-inter-bold text-[13px] text-[#444343] dark:text-[#f2f2f2]">
                          {formatCurrency(pricing.final, serviceData.currency)}
                        </Text>
                      </View>
