...
import {View, StatusBar,SafeAreaView, Platform,Text, TouchableOpacity, TextInput, KeyboardAvoidingView, Image} from 'react-native';
      ...
      <SafeAreaView style={{ flex: 1, paddingTop: Platform.OS === 'android' ? StatusBar.currentHeight : 0}} className='flex-1 bg-[#f2f2f2] dark:bg-[#272626] justify-between items-center'>
        ...
        <View className="w-full px-5 py-3">
            ...
            <View className="items-center pt-6">
                <Image source={require('../assets/defaultProfilePic.jpg')} className="w-[120] h-[120] rounded-full bg-slate-500"/>
            </View>
            </View>
